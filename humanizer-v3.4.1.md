...
When the student asks to write the acknowledgements page, ask these questions first:

> "Before I write the acknowledgements, I need a few details:
> 1. Who is your project supervisor? (Name and designation)
> 2. Anyone else to thank — HOD, lab staff, librarian, friends, family?
> 3. Any specific help to mention — dataset access, lab equipment, funding, or tools provided by someone?
>
> Answer whatever you know. I'll handle the rest."

Use the answers to write a clean, specific acknowledgements page.
Do not write a generic placeholder draft first — ask, then write.
...
- Apply the B.Tech-specific patterns (R1-R7) in the B.Tech Report-Specific Patterns section
...
- Run the "did you actually build this" checklist and the B.Tech Report Quality Checklist before finishing
...
*Content and honesty check — did you actually build what you claimed?*
...
## B.Tech Report Quality Checklist

*Formatting and completeness check — will it pass examiner review?*

Run this as a final check before submitting any B.Tech report. Flag anything missing or wrong to the user.

### 1. Preliminary pages

These appear before Chapter 1. Check all are present and in this order:

- [ ] Title page — college name, department, project title, student name, register number, batch year, supervisor name
- [ ] Declaration page — signed by the student
- [ ] Acknowledgements page
- [ ] Table of contents with correct page numbers
- [ ] List of figures (if diagrams or screenshots exist)
- [ ] List of tables (if tables exist)
- [ ] List of abbreviations (if report uses acronyms)
- [ ] All preliminary pages use Roman numerals (i, ii, iii...)

### 2. Formatting

- [ ] Font is Times New Roman throughout
- [ ] Chapter titles: 16 pt Bold Uppercase
- [ ] Main headings: 14 pt Bold
- [ ] Subheadings: 12 pt Bold
- [ ] Body text: 12 pt
- [ ] Line spacing: 1.5
- [ ] Margins: Left 1.5 inches, Right 1 inch, Top 1 inch, Bottom 1 inch (left is wider for binding)
- [ ] Arabic numerals start from Chapter 1
- [ ] Page number on every page
- [ ] Heading numbering consistent throughout (1.1, 1.2 — not mixing styles)
- [ ] Each chapter starts on a new page
- [ ] Table captions are above tables
- [ ] Figure captions are below figures
- [ ] Tables and figures numbered chapter-wise (Table 2.1, Figure 3.2)

### 3. Language and writing

- [ ] No passive voice overload — "we built", not "it was implemented"
- [ ] Tense is consistent — implementation chapters in past tense, system description in present
- [ ] No spelling or grammar errors
- [ ] No one-sentence paragraphs (unless intentional)
- [ ] No paragraph longer than 8-10 lines

### 4. Technical accuracy

- [ ] Every tool named with its version (Python 3.11, FastAPI 0.104, Qdrant 1.7)
- [ ] Every claim has a number or a citation
- [ ] Architecture diagram is present and matches what was actually built
- [ ] No features claimed that were not implemented

### 5. Citations and references

- [ ] Every paper mentioned in the Literature Review has a reference entry
- [ ] Reference format is consistent throughout (IEEE or APA — check your college)
- [ ] No dead or broken URLs in references
- [ ] Abstract is not copy-pasted into the introduction (self-plagiarism)

### 6. Figures and tables

- [ ] Every figure has a caption below it (Figure 1.1: System Architecture)
- [ ] Every table has a caption above it (Table 3.1: Technology Stack)
- [ ] Every figure and table is referenced in the body text before it appears
- [ ] No blurry or low-resolution screenshots
- [ ] Architecture diagrams are original, not downloaded from the internet

### 7. Abstract

- [ ] Standalone — readable without reading the report
- [ ] Covers problem, approach, key result, and conclusion in 150-250 words
- [ ] No citations in the abstract
- [ ] Does not open with "this report presents" — describes the project, not the document

### 8. Chapter-specific checks

| Chapter | Common examiner complaint |
|---|---|
| Introduction | Too generic, no real numbers |
| Literature review | Lists papers without analysis or gap identification |
| System design | No real architecture diagram, vague module descriptions |
| Implementation | Reads like a design chapter — present tense, no evidence of actual execution, no code snippets |
| Results | No baseline comparison, no test conditions stated |
| Conclusion | Repeats introduction, future work is vague |

### 9. Plagiarism

- [ ] Similarity score is under 20% (check your college's threshold)
- [ ] No section copy-pastes the abstract
- [ ] All referenced work is paraphrased — no copy-paste even with citation

### 10. Appendix

- [ ] Key code snippets included in appendix (not the full codebase — just the core logic)
- [ ] Appendix is referenced in the body text before it appears
- [ ] Appendix sections are labelled (Appendix A, Appendix B)
...
9. Run the B.Tech Report Quality Checklist — flag anything missing or wrong to the user
10. Check the draft sounds natural read aloud, varies sentence structure, uses
   specific details, has a recognizable voice
11. **Mandatory second pass** — Read as a skeptical examiner who has read 200
    AI-written reports. Mark every sentence that sounds assembled. Rewrite
    those sentences.
12. Ask: "What still makes this obviously AI generated?" Answer in bullets.
13. Revise. Present final version.
...
6. B.Tech Report Quality Checklist results (flag anything missing or wrong)
